...
<main class="relative min-h-screen w-full overflow-hidden">
  <div class="mx-auto flex min-h-screen w-full max-w-[1440px] flex-col px-3 pb-10 pt-3">
    ...
    <section class="flex flex-1 flex-col items-center justify-center py-16 gap-6">
      <h1 class="font-pixelify text-5xl font-semibold tracking-[8px] text-white text-center" style="text-shadow:-6px 6px 0 #00000040;">FÓRUM</h1>
      <p class="font-urbanist text-lg text-white/80 text-center max-w-md">Tire dúvidas e ajude a comunidade.</p>
